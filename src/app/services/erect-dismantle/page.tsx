...
export const metadata: Metadata = {
  ...
  description:
    "Professional scaffold erect and dismantle services in Sydney. Fully licensed riggers and scaffolders. Secure, compliant site deliveries. Call 0406 880 403.",
};
